...
Ревью
=============
Всё ок, полный балл + бонус за обучение на Coco.
Заметки:
- использовать в голове P=Softmax(С+1)[:,:-1] для ветки классов (как сделано тут) - самый распространенный вариант в детекторах, но авторы использовали сигмоиду
